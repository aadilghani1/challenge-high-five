...
const LaunchListItem: React.FC<LaunchListItemProps> = ({
  ...
  return (
    <button className="px-5 py-8 w-full rounded-lg bg-gray-50 border border-gray-300 relative text-left hover:bg-gray-100 hover:border-gray-400 transition-all duration-300 ease-out">
